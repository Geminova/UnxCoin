...
CBlock* CreateNewBlock(CWallet* pwallet, bool fProofOfStake, int64_t pFees[])
{
    ...
    else
    {
        ...
        CPubKey pubkey;
#ifdef PREM_BUILD
        struct AMOUNT reward = GetProofOfWorkReward(pindexPrev, UNX_COLOR_PREM);
#else
        struct AMOUNT reward = GetProofOfWorkReward(pindexPrev, UNX_COLOR_UNIH);
#endif
