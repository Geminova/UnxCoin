...
static const uint256 
     hashGenesisBlock("0x000028591070d359eb34883a9b26c1e7df1b4c8ad50423ffedeede43c285f381");
static const uint256 
     hashGenesisBlockTestNet("0x000252c858c6e4a35aba3b69887dbb177fecd259809d41dcdce4271390e10304");
...
public:
    ...
    bool IsUncolored()
    {
        return (nColor == (int) UNX_COLOR_NONE);
    }
...
public:
    ...
    {
        // unxcoin: the coin mint transaction is marked with
        //    first input null
...
public:
    ...
    CBlockIndex()
    {
        ...
        nChainTrust = 0;
        nCoinbaseColor = (int) UNX_COLOR_NONE;
        nFlags = 0;
        bnStakeModifier = 0;
	...
	vMoneySupply.assign(N_COLORS, 0);
        ...
        else
        {
            prevoutStake.SetNull();
            nStakeTime = 0;
            nStakeColor = (int) UNX_COLOR_NONE;
        }
