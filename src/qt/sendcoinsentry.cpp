    ...
    model(0)
{
    ...
    ui->payTo->setPlaceholderText(tr("Enter a UnxCoin address (e.g. UPg3KZKqkCHyVns744SDw6u1bKcnYDaLN3b)"));
...
void SendCoinsEntry::setModel(WalletModel *model)
{
    ...
    {
        connect(model->getOptionsModel(), SIGNAL(displayUnitChangedUnxCoin(int)), this,
...
#endif
        ui->payTo->setToolTip(qstt.arg(COLOR_NAME[nColor]).arg("UPg3KZKqkCHyVns744SDw6u1bKcnYDaLN3b"));
        break;
    default:
